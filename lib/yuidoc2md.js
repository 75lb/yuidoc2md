...
exports.getMarkdown = function(options){
    options = new exports.getMarkdownOptions().set(options);
    
    if (!options.valid){
        // options.emit("error", "Invalid options");
        return;
    }
...
exports.getMarkdownOptions = function(){
    Thing.call(this);
    this.define({
...
util.inherits(exports.getMarkdownOptions, Thing);
